        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="flex-1 max-w-md space-y-4">
            <div className="flex items-center gap-3">
              <span className="px-2.5 py-1 rounded text-[10px] font-bold uppercase tracking-[0.14em]" style={{ background: "#ece6dc", color: "#605850" }}>Current Plan</span>
          ...
          <div
            className="shrink-0 text-center p-6 rounded-md border flex flex-col items-center gap-3 min-w-[200px]"
            style={{ background: "#f6f0e8", borderColor: "rgba(216,208,200,0.4)" }}
          >
            <div className="size-12 rounded-md flex items-center justify-center" style={{ background: "rgba(194,101,42,0.12)" }}>
            ...
            <button
              className="w-full h-10 rounded text-white text-sm font-bold hover:opacity-90 transition-all mt-1"
